    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 2, 8, 14, 9, 38, 77, DateTimeKind.Utc).AddTicks(3315), "Korku", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, new DateTime(2025, 2, 8, 14, 9, 38, 77, DateTimeKind.Utc).AddTicks(3318), "Dram", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });

            migrationBuilder.InsertData(
                table: "Directors",
                columns: new[] { "DirectorId", "BirthDay", "Created", "ImageUrl", "Name", "Surname", "UpdatedTime" },
                values: new object[] { 1L, new DateTime(1959, 2, 8, 16, 39, 25, 0, DateTimeKind.Unspecified), new DateTime(2025, 2, 8, 14, 9, 38, 77, DateTimeKind.Utc).AddTicks(6843), "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcT-r2zKe07oWLgn-Sy993RYt7xe27X4_P_KP82X2Mlrs-EfZlr6_rbSnOkm_QIhRu3Zy7jukIkHAoYTexSo4OJU2g", "Nuri Bilge", "Ceylan", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
